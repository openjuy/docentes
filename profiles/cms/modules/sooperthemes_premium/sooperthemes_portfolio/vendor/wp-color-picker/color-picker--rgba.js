/* https://github.com/WordPress/WordPress/blob/master/wp-admin/js/color-picker.js */
/* global wpColorPickerL10n */
( function( $, undef ){

    // Get SooperThemes Color Palette
    // Hardcoded in this file because there is no method to set color
    var drupal_palette = [];
    for (var o in drupalSettings.sooperthemesPortfolio.palette) drupal_palette.push(drupalSettings.sooperthemesPortfolio.palette[o]);
    ...
    ColorPicker = {
        ...
        _create: function() {
            ...
            el.iris( {
                ...
                change: function( event, ui ) {
                    // PATCH: CHANGED ui.color.toString to toCSS to support rgba ~Jur
                    self.toggler.css( { backgroundColor: ui.color.toCSS('rgba') } );
